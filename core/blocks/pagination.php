...
<ul class="pagination">
  <?php if($page > 1) { ?>
  <li class="pagination__item"><a href="/book.php?id=<?=$book_id?>&amp;page=1"
      class="pagination__arrow  pagination__arrow--prev pagination__arrow--start"><span class="visually-hidden">в
        начало</span></a></li>
  <li class="pagination__item"><a href="/book.php?id=<?=$book_id?>&amp;page=<?=$page-1;?>"
...
for($i = $n; $i<= $f; $i++) { 
?>
  <li class="pagination__item"> <a <?=($i == $page) ? "" : "href='/book.php?id=$book_id&amp;page=$i'";?>
 ...
 if($page < $countPage) { ?>
  ...
  <li class="pagination__item"><a href="/book.php?id=<?=$book_id?>&amp;page=<?=$countPage;?>"
