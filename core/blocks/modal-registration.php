<section class="login login__reg">
    ...
    <form id="reg-form" action="core/business/signup__modal.php" method="post">
      <p class="input__wrapper">
        ...
        <input id="username" class="input login__input" type="text" name="username" placeholder="Ваше имя...">
      </p>
      <p class="input__wrapper">
        <label for="useremail" class="visually-hidden">Ваш почтовый ящик...</label>
        <input id="useremail" class="input login__input" type="email" name="useremail" placeholder="Ваш почтовый ящик...">
      </p>
      <p class="input__wrapper">
        <label for="userpass" class="visually-hidden">Придумайте пароль</label>
        <input id="userpass" class="input login__input" type="password" name="userpass" placeholder="Придумайте пароль">
      </p>
      <p class="input__wrapper">
        <label for="userpass2" class="visually-hidden">Повторите пароль</label>
        <input id="userpass2" class="input login__input login__input--page" type="password" name="userpass2" placeholder="Повторите пароль">
      </p>
