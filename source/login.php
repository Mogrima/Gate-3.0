...
<body class="page">
  ...
  <p class="input__wrapper">
      ...
      <input id="user-name" class="input login__input login__input--page" type="text" name="username" placeholder="Ваше имя или электронная почта..."">
  </p>
  <p class="input__wrapper">
      <label for="user-pass" class="visually-hidden">Ваш пароль</label>
      <input id="user-pass" class="input login__input login__input--page" type="password" name="password" placeholder="Ваш ключ...">
  </p>
...
?> </section>
<p class="login__text">Не зарегистрированы? <a class="login__link-to-reg" href="registration.html">Тогда вам сюда</a></p>
</div><!-- Подложка -->
</div>
</main>
