    ...
    <div class="container">
      <div class="substrate">
        ...
        <div class="page-main__head">
          ...
          <p class="page-main__intro-text">Арт-проект <span class="page-main__label">«Врата»</span>  посвящён искусству в разных его формах авторства <a class="link link--reviews" href="#">Роджера</a> и <a class="link link--reviews" href="#">Могримы</a>.</p> <p class="page-main__intro-text">Здесь Вы найдёте:</p>
          ...
          <li class="page-main__intro-item"> а так же комикс «Бесконечная история», <span class="grey">выпуск которого только начался</span>.</li>
          </ul>
          <p class="page-description page-description--flex">Отличительная черта творчества за Вратами - загадка в каждом произведении, дух тайны, рождаемой фантазией.
          Врата раскрывают множество путей, отведущих ваше воображение по тропам к давно сгинувшим мирам, а может даже к истокам истории. За ними изложены и показаны судьбы.
